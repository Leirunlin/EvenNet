...
def DatasetLoader(name):
    ...
    if name in ['cora', 'citeseer', 'pubmed']:
        ...
        path = '../data/'
        train_dataset = dataset_ContextualSBM(path, name=name, split='train')
        val_dataset = dataset_ContextualSBM(path, name=name, split='val')
        test_dataset = dataset_ContextualSBM(path, name=name, split='test')
